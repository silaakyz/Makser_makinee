...
const statusConfig: Record<string, { label: string; variant: string; className: string }> = {
  aktif: { label: "Aktif", variant: "default", className: "bg-success text-success-foreground" },
  boşta: { label: "Boşta", variant: "secondary", className: "bg-muted text-muted-foreground" },
  ...
  devam_ediyor: { label: "Devam Ediyor", variant: "default", className: "bg-accent text-accent-foreground" },
  ...
  uretimde: { label: "Üretimde", variant: "default", className: "bg-accent text-accent-foreground" },
  stok: { label: "Stok", variant: "default", className: "bg-primary text-primary-foreground" },
  uretim: { label: "Üretim", variant: "default", className: "bg-accent text-accent-foreground" },
};
